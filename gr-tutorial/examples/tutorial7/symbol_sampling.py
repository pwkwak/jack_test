...
# Generated: Mon Jan 29 16:23:31 2018
##################################################
...
class symbol_sampling(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_vector_source_x_0_1, 0), (self.qtgui_time_sink_x_1, 0))    
        ...
        self.connect((self.fir_filter_xxx_0_1, 0), (self.qtgui_time_sink_x_1, 2))    
        ...
        self.connect((self.interp_fir_filter_xxx_0_1, 0), (self.qtgui_time_sink_x_1, 1))    
