...
# Generated: Fri Jan 26 23:51:03 2018
##################################################
...
class tutorial_two_6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._samp_rate_options = (48000, 24000, 160000, )
        self._samp_rate_labels = ("48000", "24000", "160000", )
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_freq_sink_x_0, 1))    
