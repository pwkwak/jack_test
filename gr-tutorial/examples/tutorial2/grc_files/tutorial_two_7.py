...
# Generated: Sat Jan 27 04:04:46 2018
##################################################
...
class tutorial_two_7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100e-6, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 20e3*probe_var, 500e-3, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.probe_signal, 0))    
    ...
    def set_probe_var(self, probe_var):
        ...
        self.analog_sig_source_x_0.set_frequency(20e3*self.probe_var)
