...
# Title: Tags Decim
# Generated: Fri Jan 26 23:53:59 2018
##################################################
...
class tags_decim(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tags Decim")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tags Decim")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "tags_decim")
...
def main(top_block_cls=tags_decim, options=None):
